                    ...
                    {orders.sort(
                        ...
                        return (
                            <View style={styles.order} key={index}>
                                            ...
                                            <View style={styles.rowout}>
                                                <View style={styles.row}>
                                                    <View style={styles.left}>
                                                        ...
                                                        <Text style={styles.price1}>Pkr {item.data.foodPrice}</Text>
                                                    </View>
                                                    <View style={styles.right}>
                                                        <Text style={styles.totalprice}>Pkr {parseInt(item.Foodquantity) * parseInt(item.data.foodPrice)}</Text>
                                                    </View>
                                                </View>
                                                ...
                                                <View style={styles.row}>
                                                    <View style={styles.left}>
                                                        ...
                                                        <Text style={styles.price1}>Pkr {item.data.foodAddonPrice}</Text>
                                                    </View>
                                                    <View style={styles.right}>
                                                        <Text style={styles.totalprice}>Pkr {parseInt(item.Addonquantity) * parseInt(item.data.foodAddonPrice)}</Text>
                                                    </View>
                                                </View>
                                            </View>
                                        )
                                ...
                                <Text style={styles.total}>Total: Pkr {order.ordercost}</Text>
                                {
